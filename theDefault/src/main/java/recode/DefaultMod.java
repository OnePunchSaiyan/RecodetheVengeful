...
import recode.util.IDCheckDontTouchPls;
import recode.util.TextureLoader;
import recode.variables.DefaultCustomVariable;
import recode.variables.DefaultSecondMagicNumber;
    ...
    public DefaultMod() {
      ...
      */
        ...
        BaseMod.addColor(Recode.Enums.COLOR_ORANGE,
                ...
                RECODE_ORANGE,
                RECODE_ORANGE,
                ATTACK_RECODE_ORANGE,
                SKILL_RECODE_ORANGE,
                POWER_RECODE_ORANGE,
                ENERGY_ORB_RECODE_ORANGE,
                ATTACK_RECODE_ORANGE_PORTRAIT,
                SKILL_RECODE_ORANGE_PORTRAIT,
                POWER_RECODE_ORANGE_PORTRAIT,
                ENERGY_ORB_RECODE_ORANGE_PORTRAIT,
                CARD_ENERGY_ORB_RECODE_ORANGE);
