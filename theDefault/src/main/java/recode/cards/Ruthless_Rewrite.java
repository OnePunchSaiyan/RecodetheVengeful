...
public class Ruthless_Rewrite extends AbstractDynamicCard {


    public static final String ID = DefaultMod.makeID ( Ruthless_Rewrite.class.getSimpleName () );
