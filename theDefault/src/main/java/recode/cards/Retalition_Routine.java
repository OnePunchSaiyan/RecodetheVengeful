...
public class Retalition_Routine extends AbstractDynamicCard {


    public static final String ID = DefaultMod.makeID ( Retalition_Routine.class.getSimpleName () );
