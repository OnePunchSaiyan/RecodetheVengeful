...
public class CardTemplate extends AbstractDynamicCard {
    ...
    // TEXT DECLARATION
     ...
     //public static final String ID = DefaultMod.makeID(${Attack}); // USE THIS ONE FOR THE TEMPLATE;.class.getSimpleName()); // USE THIS ONE FOR}); // USE THIS ONE FOR THE TEMPLATE;.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
